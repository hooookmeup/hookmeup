...
/*
var appID = "1432628966956620"; // YOUR APP ID
//    my_secret = "f8b0694baff168708f8db1e2cd7541dc", // YOUR APP SECRET 
...
function fbLogin() {
    ...
    checkFbHashLogin();
    //window.top.location.href = window.location.replace(url);
}
...
function displayUser(user) {
    ...
    if (user.id != null && user.id != "undefined") {
        ...
        console.log(user.id + " " + user.name + " " + user.first_name + " " + user.last_name + " " + user.link + " " + user.username + " " + user.gender + " " + user.locale + " " + user.age_range);
    }
    else {
        alert('user error');
    }
