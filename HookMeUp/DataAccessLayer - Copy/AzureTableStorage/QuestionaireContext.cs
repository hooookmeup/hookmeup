...
{
    public partial class  QuestionaireContext 
    {
    /* 
	
	//   This is an example of custom developed query
	public List<Questionaire> MethodName(list of method parameters )
        {
            List<Questionaire> rez = new List<Questionaire>();
            NextRecordInfo nextRec = new NextRecordInfo() ;
            	do	
				{
                	DataServiceQuery<Questionaires> Qtran = (DataServiceQuery<Questionaires>)servCtx.CreateQuery<Questionaires>(TableName).Where(c => enter query details here );
	...
	*/
     ...
     //Add your extension methods here for  QuestionaireContext class.
