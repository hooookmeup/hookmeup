...
{
    public partial class  ErrorMappingContext 
    {
    /* 
	
	//   This is an example of custom developed query
	public List<ErrorMapping> MethodName(list of method parameters )
        {
            List<ErrorMapping> rez = new List<ErrorMapping>();
            NextRecordInfo nextRec = new NextRecordInfo() ;
            	do	
				{
                	DataServiceQuery<StampSheetHistorys> Qtran = (DataServiceQuery<StampSheetHistorys>)servCtx.CreateQuery<StampSheetHistorys>(TableName).Where(c => enter query details here );
	...
	*/
     ...
     //Add your extension methods here for  ErrorMappingContext class.
