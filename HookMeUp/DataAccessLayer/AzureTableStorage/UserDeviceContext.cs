...
{
    public partial class  UserDeviceContext 
    {
    /* 
	
	//   This is an example of custom developed query
	public List<UserDevice> MethodName(list of method parameters )
        {
            List<UserDevice> rez = new List<UserDevice>();
            NextRecordInfo nextRec = new NextRecordInfo() ;
            	do	
				{
                	DataServiceQuery<UserDevices> Qtran = (DataServiceQuery<UserDevices>)servCtx.CreateQuery<UserDevices>(TableName).Where(c => enter query details here );
	...
	*/
     ...
     //Add your extension methods here for  UserDeviceContext class.
